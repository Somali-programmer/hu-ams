      ...
      >
        ...
        <div className="px-8 md:px-12 pb-12">
          ...
          <div className="space-y-10">
            <div>
              <h1 className="text-2xl md:text-4xl font-serif font-bold text-black">{user.fullName}</h1>
              <p className="text-gray-black/40 capitalize font-bold tracking-[0.2em] text-xs mt-1">{user.role}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 pt-10 border-t border-gray-50">
              {[
